    ...
    .then(function () {
      ...
      return knex('authors').insert([
        ...
        },
        {
          fName: 'Kyle',
          lName: 'Simpson ',
          biography: 'Kyle is an Open Web Evangelist who\'s passionate about all things JavaScript. He\'s an author, workshop trainer, tech speaker, and OSS contributor/leader.',
